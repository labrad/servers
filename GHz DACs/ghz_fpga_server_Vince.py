...
class FPGAServer(DeviceServer):
    ...
    def loadBoardGroupConfig(self):
        ...
        p.get('boardGroupsVince', True, [], key='boardGroupsVince')
        ans = yield p.send()
        ...
        names = set()
        adapters = set()
        for name, server, port, boards in ans['boardGroupsVince']:
            if name in names:
        ...
        if valid:
            self.boardGroupDefs = ans['boardGroupsVince']
