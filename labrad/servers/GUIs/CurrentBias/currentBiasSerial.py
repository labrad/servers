    ...
    class MainWindow (QtGui.QMainWindow):
        ...
        def on_fineCoarseSelectA_sliderReleased(self):
            ...
            if self.ui.fineCoarseSelectA.sliderPosition():
                print 'coarse'
                self.setvoltage('A',1L,self.ui.fastSlowSelectA.sliderPosition(),setCoarseA*V)
            else:
                print 'fine'
                self.setvoltage('A',0L,self.ui.fastSlowSelectA.sliderPosition(),setFineA*V)
        ...
        def on_fineCoarseSelectB_sliderReleased(self):
            ...
            if self.ui.fineCoarseSelectB.sliderPosition():
                self.setvoltage('B',1L,self.ui.fastSlowSelectB.sliderPosition(),setCoarseB*V)
            else:
                self.setvoltage('B',0L,self.ui.fastSlowSelectB.sliderPosition(),setFineB*V)
        ...
        def on_coarseBoxB_valueChanged(self, value):
            ...
            if self.ui.fineCoarseSelectB.sliderPosition():
                self.setvoltage('B',1L,self.ui.fastSlowSelectD.sliderPosition(),setCoarseB*V)         
        ...
        def on_fineCoarseSelectC_sliderReleased(self):
            ...
            if self.ui.fineCoarseSelectC.sliderPosition():
                self.setvoltage('C',1L,self.ui.fastSlowSelectC.sliderPosition(),setCoarseC*V)
            else:
                self.setvoltage('C',0L,self.ui.fastSlowSelectC.sliderPosition(),setFineC*V)
        ...
        def on_fineCoarseSelectD_sliderReleased(self):
            ...
            if self.ui.fineCoarseSelectD.sliderPosition():
                self.setvoltage('D',1L,self.ui.fastSlowSelectD.sliderPosition(),setCoarseD*V)
            else:
                self.setvoltage('D',0L,self.ui.fastSlowSelectD.sliderPosition(),setFineD*V)
        ...
        def on_fineSliderD_sliderReleased(self):
            ...
            if not self.ui.fineCoarseSelectD.sliderPosition():
                self.setvoltage('D',0L,self.ui.fastSlowSelectC.sliderPosition(),setFineD*V)
