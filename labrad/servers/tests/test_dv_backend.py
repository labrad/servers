...
from labrad.servers.datavault import backend
from labrad.servers.datavault import util
import numpy as np
import pytest
import tempfile
import os
...
def test_create_ex_backend():
    ...
    try:
        ...
        rec_array = util.to_record_array(np.eye(4))
        ...
        data = util.from_record_array(data)
