        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    # expected triggers. These triggers are send along with the collect packets,
                ...
                # If expected number of packets are returned, sends triggers to master context
                # so that next person can run. If timeout, triggers not sent.
